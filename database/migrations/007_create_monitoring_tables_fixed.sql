...
CREATE TABLE IF NOT EXISTS "LiteLLM_ErrorLogs" (
    error_id                TEXT DEFAULT uuid_generate_v4(),
    timestamp               TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
