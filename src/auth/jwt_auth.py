...
def require_org_admin(current_user: User = Depends(require_roles("PROXY_ADMIN", "ORG_ADMIN"))) -> User:
    """Require PROXY_ADMIN or ORG_ADMIN role.""" 
    return current_user


def require_team_admin(current_user: User = Depends(require_roles("PROXY_ADMIN", "ORG_ADMIN", "TEAM_ADMIN"))) -> User:
    """Require admin roles."""
    return current_user