...
class ConnectionActivity(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "status_code >= 100 AND status_code < 600", name="valid_status_code"
        ),
        CheckConstraint(
            "prompt_tokens IS NULL OR prompt_tokens >= 0", name="valid_prompt_tokens"
        ),
        CheckConstraint(
        ...
        CheckConstraint(
            "total_tokens IS NULL OR total_tokens >= 0", name="valid_total_tokens"
        ),
        CheckConstraint(
...
class ActivitySummary(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("period_end > period_start", name="valid_period_range"),
        CheckConstraint(
